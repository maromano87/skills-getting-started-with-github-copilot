...
activities = {
    ...
    "Basketball Club": {
        "description": "Casual and league basketball sessions for all skill levels",
    ...
    "Art Workshop": {
        "description": "Painting, drawing, and mixed-media projects for creative development",
        "schedule": "Fridays, 3:30 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["mia@mergington.edu", "oliver@mergington.edu"]
    },
    "Debate Team": {
        "description": "Formal debate practice, public speaking, and interschool competitions",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["henry@mergington.edu", "chloe@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Design and build robots, learn electronics and compete in challenges",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 14,
        "participants": ["noah@mergington.edu", "emma.r@mergington.edu"]
    }
}
